...
public class QuestionRepositoryImpl implements QuestionRepository {
    ...
    private static final List<Question> QUESTIONS = Arrays.asList(
            new Question(0L, "Батон - это толстый рыжий кот с желтыми полосками на спине и хвосте. Он очень любит есть и спать. Кот не любит, когда его еда пропадает.\n" +
            ...
            new Question(1L, "Кот Батон решил поискать в гостиной свою еду. Он пошел в самую большую комнату. Искать ..."),
            new Question(2L, "Кот Батон потопал в ванную. Дверь была открыта, ему не пришлось возиться с ручкой. Кот решил поискать ..."),
            new Question(3L, "Кот Батон пошел в туалет. Он заглянул в унитаз и под раковину, но ничего не нашел. Тогда Батон решил поискать ..."),
            new Question(4L, "Кот Батон протиснулся в свою маленькую дверку и вышел в сад. Он осмотрелся и решил поискать ..."),
            new Question(5L, "Кот Батон залез под стол и нашел только карандаш. Кот решил поискать ..."),
            new Question(6L, "Кот Батон не смог протиснуться под диван. Он положил голову на пол, закрыл один глаз и заглянул, но ничего не увидел. Кот решил поискать ..."),
            new Question(7L, "Кот Батон лапой открыл дверку шкафа и уткнулся мордой в чистое белье. Он внимательно осмотрел и обнюхал его, но так и не нашел свой корм. Тогда он попытался закрыть дверку, но не получилось, торчащие полотенца мешали это сделать. Кот Батон уперся лапами в них, потом резко отскочил и захлопнул дверь. Кот довольно мяукнул и решил поискать..."),
            new Question(8L, "Кот Батон попытался протиснуться в стиральную машину, но его голова чуть не застряла в окошке. Кот с трудом вытащил ее и обнюхал стиральную машину. Он нашел только забытый носок. Батон решил поискать ..."),
            new Question(9L, "Кот Батон залез в песочницу. Он начал копать песок, но так ничего и не нашел. Батон решил ..."),
            new Question(10L, "Кот Батон залез в заросли кустов. Он поломал веточки и помял листы. После недолгих поисков кот вылез наружу.\n" +
                    "\n" +
            ...
            new Question(11L, "Кот Батон прибежал на кухню. Кот грустно посмотрел вверх. Шкаф высокий, он не сможет допрыгнуть до полки. Тогда Батон решил ..."),
            new Question(12L, "- Мя-я-я-я-я-я-у-у-у! Мя-я-яву-у-у! А-а-а-а-а-а-а-а-а-а-а! - орал кот Батон.\n" +
                    "Он решил ..."),
            new Question(13L, "Кот Батон сердито боднул шкаф. Стаканы, стоявшие на полках, тихо зазвенели. Батон решил ..."),
            new Question(14L, "Кот Батон придвинул стул к столу, чтобы добраться до верхней полки. Кот запрыгнул на скользкую поверхность. Батон грациозно подпрыгнул, будто дикий тигр. У него получилось схватиться за ручку дверцы, открыть ее и уцепиться за полку. Батон повис на ней и залез в шкаф. Там кота ждала большая упаковка корма. Кот Батон засунул морду в пакет и начал жадно есть еду."));
